...
% ============================================================
% PÁGINA 1: IDENTIFICAÇÃO DOS AUTORES
% ============================================================
\thispagestyle{empty}
\begin{center}
...
\noindent\textbf{Autora 1}\\
Nome completo: Shauna Bobadilha Rodrigues de Lima\\
T\'itulo acad\^emico: Doutora em Economia\\
Afilia\c{c}\~ao institucional: Programa de P\'os-Gradua\c{c}\~ao em Organiza\c{c}\~ao e Mercados, Universidade Federal de Pelotas\\
Minicurr\'iculo: Doutora em Economia pelo Programa de P\'os-Gradua\c{c}\~ao em Organiza\c{c}\~ao e Mercados da Universidade Federal de Pelotas.\\
Endere\c{c}o postal: Rua Gomes Carneiro, 01 -- Balsa, Pelotas -- RS, 96010-610\\
E-mail: \texttt{shasha.bobadilha@hotmail.com}\\
Telefone: (53) 99966-5841\\

\bigskip

\noindent\textbf{Autor 2}\\
Nome completo: Alisson Tallys Geraldo Fiorentin\\
T\'itulo acad\^emico: Doutorando em Economia Aplicada\\
Afilia\c{c}\~ao institucional: Programa de P\'os-Gradua\c{c}\~ao em Economia, Universidade Federal do Rio Grande do Sul\\
Minicurr\'iculo: Doutorando em Economia Aplicada pelo Programa de P\'os-Gradua\c{c}\~ao em Economia da Universidade Federal do Rio Grande do Sul.\\
Endere\c{c}o postal: Bairro Farroupilha, Porto Alegre -- RS, 90040-040\\
E-mail: \texttt{alisson.fiorentin@ufrgs.br}\\
Telefone: (53) 99139-4392\\

\bigskip

\noindent\textbf{Autor 3}\\
Nome completo: Gibran da Silva Teixeira\\
T\'itulo acad\^emico: Professor Doutor\\
Afilia\c{c}\~ao institucional: Programa de P\'os-Gradua\c{c}\~ao em Economia Aplicada, Universidade Federal do Rio Grande\\
Minicurr\'iculo: Professor Doutor no Programa de P\'os-Gradua\c{c}\~ao em Economia Aplicada da Universidade Federal do Rio Grande.\\
Endere\c{c}o postal: Km~8 Avenida It\'alia, Carreiros -- Rio Grande, RS, 96203-900\\
E-mail: \texttt{tgibran@hotmail.com}\\
Telefone: (53) 99901-1263\\

\clearpage

% ============================================================
% PÁGINA 2: TÍTULO, RESUMO, PALAVRAS-CHAVE E JEL
